...
BEGIN
    BEGIN TRY
        ...
        -- Insertar abono
        INSERT INTO Abonos (Sale_Id, Card_Num, Abono_Amount, Abono_Date, Observaciones, Id_Empleado)
        VALUES (@Sale_Id, @Card_Num, @Abono_Amount, GETDATE(), @Observaciones, @Id_User);
